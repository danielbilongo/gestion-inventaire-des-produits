package com.daniel.gestion_inventaire_produits.controller;



import com.daniel.gestion_inventaire_produits.dto.ProduitRequest;
import com.daniel.gestion_inventaire_produits.dto.ProduitResponse;
import com.daniel.gestion_inventaire_produits.exception.ResourceNotFoundException;
import com.daniel.gestion_inventaire_produits.service.ProduitService;
...
@RequestMapping("/api/produits") // Chemin de base pour toutes les requêtes de ce contrôleur
public class ProduitController {

    private final ProduitService produitService;

    // Injection par constructeur (sans @Autowired explicite car un seul constructeur)
    ...
    // GET /api/produits/stock-bas?seuil={seuil} : Récupérer les produits en stock bas
    ...
    // GET /api/produits/search?nom={nom} : Rechercher des produits par nom
    @GetMapping("/search")
